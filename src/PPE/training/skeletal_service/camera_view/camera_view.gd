...
func initialize(landmarks_provider: LandmarksProvider) -> void:
...
func _draw_landmarks(_camera_feed_id: int, result: MediaPipePoseLandmarkerResult, image: MediaPipeImage, _timestamp_ms: int) -> void:
